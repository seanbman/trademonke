...
2. Implement persistent liquidity-level lifecycles, accepted-breakout classification, explicit V-shaped recovery, original FVG/IFVG relationships, and the ordered institutional sequence.
...
5. Add A/A+/A++ analytical streams, independent immediate/Fib-sniper models, target boxes, session-aware draws on liquidity, and outcome attribution.
