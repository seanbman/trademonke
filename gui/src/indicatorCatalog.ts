...
export const FUTURE_CATALOG: CatalogEntry[] = [
  {
    id: "detector:order_blocks",
    kind: "indicator",
    title: "Order / rejection blocks",
    summary: "Closed-candle origin zones before a displacement leg. Research overlays via TA summary — not trade authority.",
    looksLike: "Zone from the last opposing candle before expansion.",
    identification: "app.domain.structure.detect_order_blocks on closed candles only.",
    guiFlags: "Shown under Technical analysis summary → order blocks.",
    authority: "soft_label",
    guideHint: "guide/09-fvg-and-order-blocks.md",
  },
  {
    id: "detector:structure_labels",
    kind: "indicator",
    title: "BOS / CHoCH / MSS labels",
    summary: "Named refinements of structure breaks for invalidation alerts and research streams.",
    looksLike: "Event labels on measured close-beyond-extreme breaks.",
    identification: "app.domain.structure.classify_structure_break",
    guiFlags: "Invalidation alerts use bos/choch/mss event types.",
    authority: "soft_label",
  },
  {
  ...
  {
    id: "detector:sessions_killzone",
    kind: "indicator",
    title: "Sessions / kill-zone windows",
    summary: "Deterministic UTC kill-zone membership for confluence gating (research scoring).",
    looksLike: "Session context on the TA summary panel.",
    identification: "app.domain.sessions.in_kill_zone",
    guiFlags: "TA summary → session context.",
    authority: "soft_label",
  ...
  },
  {
    ...
    guiFlags: "Not in workstation yet. Confluence scorecard skips microstructure (weight 0).",
    authority: "future",
